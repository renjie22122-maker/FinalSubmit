			...
			if (count != 0) {
				...
				try {
					...
					if (apiKey == null || apiKey.trim().isEmpty())
						throw new IllegalStateException("GOOGLE_MAPS_API_KEY is required for satellite image download");
					URL url = new URL("https://maps.googleapis.com/maps/api/staticmap?center="+latLong.x+","+latLong.y+"&zoom=20&size=640x640&maptype=satellite&format=png32&key="+apiKey);
