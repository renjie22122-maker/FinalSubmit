...
% Compatibility shim for the current datatool 3.4.3 latin1 loader.  The
% distributed loader calls an `:ne` variant that the installed base file does
% not generate; defining that variant has no visual or layout effect.
\ExplSyntaxOn
\cs_if_exist:NF \datatool_set_currencysign_from_charcode:ne
  {
    \cs_new:Npn \datatool_set_currencysign_from_charcode:ne #1#2
      {\exp_args:Nne \datatool_set_currencysign_from_charcode:nn {#1}{#2}}
  }
\ExplSyntaxOff
...
% Content compatibility for the updated dissertation.  These additions do not
% override the typography, chapter, page, list, caption, hyperlink, or listing
% styles defined by the original template above.
\usepackage{tabularx}
\graphicspath{{figures/}{figures/generated/}{Logos/}}
\DeclareSIUnit\pixel{px}
\definecolor{uclblue}{HTML}{003D4C}
\definecolor{evidenceblue}{HTML}{0072B2}
\definecolor{evidenceorange}{HTML}{D55E00}
\definecolor{evidencegreen}{HTML}{009E73}
\definecolor{lightgrey}{HTML}{F2F4F5}
\newcommand{\implemented}{\textsc{implemented}}
\newcommand{\exercised}{\textsc{exercised}}
\newcommand{\validated}{\textsc{validated}}
\newcommand{\planned}{\textsc{planned}}
\newcommand{\unresolved}{\textsc{unresolved}}
\newcommand{\code}[1]{\texttt{#1}}
\newcommand{\evidencebox}[1]{%
  \begin{center}\fbox{\parbox{0.91\textwidth}{#1}}\end{center}}
